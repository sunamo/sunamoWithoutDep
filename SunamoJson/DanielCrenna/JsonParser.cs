...
public static object Deserialize(IDictionary<string, object> bag, Type type)
        {
            object instance;
        ...
        public static IDictionary<string, object> GetBagForObject(Type type, object instance)
        {
        ...
        public static IDictionary<string, object> GetBagForObject<T>(T instance)
        {
            return GetBagForObject(typeof(T), instance);
        }

        public static Dictionary<string, object> InitializeBag()
        {
        ...
        public static void CacheReflection(Type item)
        {
        ...
        public static void SerializeItem(StringBuilder sb, object item)
        {
        ...
        public static void SerializeDateTime(StringBuilder sb)
        {
        ...
        public static void SerializeArray(object item, StringBuilder sb)
        {
        ...
        public static void SerializeObject(object item, StringBuilder sb)
        {
        ...
        public static void SerializeString(StringBuilder sb, object item)
        {
            sb.Append("\"");
        ...
        public static KeyValuePair<string, object> ParsePair(IList<char> data, ref int index)
        {
            var valid = true;
        ...
        public static bool ParseToken(JsonToken token, IList<char> data, ref int index)
        {
            var nextToken = NextToken(data, ref index);
            return token == nextToken;
        }

        public static string ParseString(IList<char> data, ref int index)
        {
        ...
        public static object ParseValue(IList<char> data, ref int index)
        {
            var token = NextToken(data, ref index);
            switch (token)
            {
        ...
        public static IDictionary<string, object> ParseObject(IList<char> data, ref int index)
        {
        ...
        public static IEnumerable<object> ParseArray(IList<char> data, ref int index)
        {
        ...
        public static object ParseNumber(IList<char> data, ref int index)
        {
            var symbol = data[index];
            IgnoreWhitespace(data, ref index, symbol);
        ...
        public static JsonToken NextToken(IList<char> data, ref int index)
        {
            var symbol = data[index];
        ...
        public static JsonToken GetTokenFromSymbol(char symbol)
        {
            return GetTokenFromSymbol(symbol, JsonToken.Unknown);
        }

        public static JsonToken GetTokenFromSymbol(char symbol, JsonToken token)
        {
            switch (symbol)
            {
                case '{':
        ...
        public static void IgnoreWhitespace(IList<char> data, ref int index, char symbol)
        {
        ...
        public static JsonToken IgnoreWhitespace(IList<char> data, ref int index, ref JsonToken token, char symbol)
        {
            switch (symbol)
            {
                case ' ':
